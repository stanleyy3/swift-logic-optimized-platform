...
const float form_lr_choices[FORM_LR_CHOICES] = { 0.01f, 0.02f, 0.05f, 0.1f, 0.2f };

// presets that left/right steps through on the freely-typed fields
static const int epoch_presets[] = { 1, 2, 5, 10, 15, 20, 30, 40 };
